...
//        return this;
//    }
//    public CustomerSeatView setSeatType(String seatType){
//        this.seatType = SeatsType.getSeatLayout(seatType);
//        return this;
//    }
//
...
//        int count = 0;
//
//        for (int index = 0; index < seatType.length(); index++) {
//            if (seatType.charAt(index) == '/') {
//                layout = new LinearLayout(context);
//                layout.setOrientation(LinearLayout.HORIZONTAL);
//                layoutSeat.addView(layout);
//            } else if (seatType.charAt(index) == 'U') {
//                count++;
...
//            } else if (seatType.charAt(index) == 'A') {
//                count++;
//                TextView view = new TextView(context);
//                LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(seatSize, seatSize);
//                layoutParams.setMargins(seatGaping, seatGaping, seatGaping, seatGaping);
...
//                seatViewList.add(view);
//                view.setOnClickListener(this);
//            } else if (seatType.charAt(index) == 'R') {
//                count++;
//                TextView view = new TextView(context);
//                LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(seatSize, seatSize);
//                layoutParams.setMargins(seatGaping, seatGaping, seatGaping, seatGaping);
...
//                seatViewList.add(view);
//                view.setOnClickListener(this);
//            } else if (seatType.charAt(index) == '_') {
//                TextView view = new TextView(context);
//                LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(seatSize, seatSize);
//                layoutParams.setMargins(seatGaping, seatGaping, seatGaping, seatGaping);
//                view.setLayoutParams(layoutParams);
